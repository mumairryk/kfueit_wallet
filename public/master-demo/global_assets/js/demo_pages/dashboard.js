...
var Dashboard = function () {
            ...
            var tooltip = d3.tip()
                ...
                .html(function (d) {
                    return '<ul class="list-unstyled mb-1">' +
                        ...
                        '<li>' + 'Balanc: &nbsp;' + '<span class="font-weight-semibold float-right">' + d.value + '</span>' + '</li>' +
            ...
            var tooltip = d3.tip()
                ...
                .html(function (d) {
                    return '<ul class="list-unstyled mb-1">' +
                        ...
                        '<li>' + 'Balance: &nbsp;' + '<span class="font-weight-semibold float-right">' + d.alpha + '</span>' + '</li>' +
    ...
    var _BarChart = function(element, barQty, height, animate, easing, duration, delay, color, tooltip) {
        ...
        if($(element).length > 0) {
            ...
            // Show and hide
            if(tooltip == 'hours' || tooltip == 'goal' || tooltip == 'balance') {
                bars.call(tip)
            ...
            // Online balance tooltip content
            if(tooltip == 'balance') {
                tip.html(function (d, i) {
                    return '<div class="text-center">' +
                            '<h6 class="m-0">' + d + '0' + '</h6>' +
    ...
    return {
        ...
        initCharts: function() {
            ...
            // Line charts
            _AppSalesLinesChart('#app_sales', 255);
            _DailyRevenueLineChart('#un-paid-vochar', 50);
            ...
            _BarChart('#members-online', 10, 40, true, 'elastic', 1200, 50, 'rgba(255,255,255,0.5)', 'balance');
